...
def build_schema():
    characteristic_name = next(parse_yaml('_data/characteristics.yml')).keys()
    return {
        "definitions": {
            'examples': {
                'type': 'object',
        ...
        'properties': {
            ...
            'characteristics': {
                ...
                "patternProperties": {
                    '^({})$'.format(
                        '|'.join(characteristic_name)
                    ): {'$ref': '#/definitions/examples'}
                },
                'required': list(characteristic_name),
                'additionalProperties': False
            },
        },
